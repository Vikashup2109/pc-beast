      ...
      <div className="w-11/12 desktop:w-4/5 py-6 justify-center text-white mx-auto">
        ...
        <div className="desktop:mx-12 my-6">
          <div className="grid grid-cols-2 tablet:grid-cols-4 gap-6 mid:gap-12 text-center justify-center text-xl font-bold font-mono">
            ...
            <div className="flex flex-col space-y-2 my-4">
              <a
                href="https://www.linkedin.com/in/pc-beast/"
                target="_blank"
                className="flex flex-col space-y-2"
                rel="noreferrer"
              >
                ...
                <span className="text-sm break-words"> @pc-beast </span>
              </a>
            </div>
            <div className="flex flex-col space-y-2 my-4">
              <a
                href="mailto:pavnesh.chaturvedi@gmail.com"
                target="_blank"
                className="flex flex-col space-y-2"
                rel="noreferrer"
              >
                ...
                <span className="text-sm break-words">
                  {" "}
                  pavnesh.chaturvedi@gmail.com{" "}
                </span>
              </a>
            </div>
            <div className="flex flex-col space-y-2 my-4">
              <a
                href="https://www.instagram.com/insta_pavnesh/"
                target="_blank"
                className="flex flex-col space-y-2"
                rel="noreferrer"
              >
